# GFM_BollingerTwoSD.py
#
# A formatter plugin for fixed interval stepped hash tables with an interval
# picked for the specific table based on recent history, formatted for
# GitHub-Flavored Markdown (GFM), e.g. as used by Steemit articles.
#
# Generally not imported directly.
# Use TableFormatters.GetFMT("gfm_bollingertwosd", ...) to get instance.
#
import textwrap
from .common import *

@register_formatter("gfm_plainoldlist")
class Formatter:
    ...
    ## Hash Table Set: [%(pair)s] (Target:&nbsp;%(date_long)s)\n
    """ +
    ...
    **Event to Report:**
     * %(eventdesc)s\n
    **Price Points:**\n
    Selected price levels are illustrated here:\n
    %(imglink)s\n
    **Reporting Method:**
     * %(reportmethod)s\n
